    ...
    <div class="fullPage d-flex justify-content-around align-items-center">
        <div>
            ...
            <form class="mt-3">
                ...
                <input class="form-control border-secondary-subtle" type="email" placeholder="example@email.com"><br>
                <label class="form-label">Senha</label>
                <input class="form-control border-secondary-subtle" type="password" placeholder="***********">
                <div class="d-flex gap-3 mt-3">
                    <div class="form-check">
                        <input class="form-check-input border-secondary-subtle" type="checkbox" id="gridCheck">
                ...
                <input class="btn btn-primary w-100 mt-3" type="submit">
            </form>
